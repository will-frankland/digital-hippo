...
const ThankYouPage = async ({ searchParams }: PageProps) => {
  ...
  return (
    <main className="relative lg:mix-h-full">
      ...
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
        <div className="lg:col-start-2">
          ...
          {order._isPaid ? (
            ...
            <p className="mt-2 text-base text-muted-foreground">
              We&apos;re currently processing it. Hang tight, this won&apos;
              take long. We&apos;ll send confirmation very soon!
            </p>
          )}
          <div className="mt-16 text-sm font-medium">
            <div className="text-muted-foreground">Order Number:</div>
            <div className="mt-2 text-gray-900">{order.id}</div>
            <ul className="mt-6 divide-y divide-gray-200 border-top border-gray-200 text-sm font-medium text-muted-foreground">
                    ...
                    <div className="relative h-24 w-24">
                      {typeof image !== "string" && image.url ? (
                        <Image
                          ...
                          className="flex-none rounded-medium bg-gray-100 object-cover object-center"
                        />
                      ) : null}
                    </div>
