...
var ReceiptEmail = function (_a) {
    ...
    return (react_1.default.createElement(components_1.Html, null,
        ...
        react_1.default.createElement(components_1.Preview, null, "Your HippoHub Receipt"),
            ...
            react_1.default.createElement(components_1.Container, { style: container },
                react_1.default.createElement(components_1.Section, null,
                    react_1.default.createElement(components_1.Column, null,
                        react_1.default.createElement(components_1.Img, { src: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/hippo-email-sent.png"), width: '100', height: '100', alt: 'HippoHub' })),
...
var ReceiptEmailHtml = function (props) { return (0, components_1.render)(react_1.default.createElement(ReceiptEmail, __assign({}, props)), {
    pretty: true
}); };
